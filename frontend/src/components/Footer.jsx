    ...
    <footer className="bg-theme-secondary text-theme-primary pt-16 pb-8 border-t border-theme-primary/10 transition-colors duration-500">
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-12">
          ...
          <div>
            ...
            <div className="space-y-3 text-theme-bgPrimary/80">
              <p><span className="font-semibold">Email:</span> hello@marginnotes.com</p>
              <p><span className="font-semibold">Phone:</span> (555) 123-4567</p>
              <p><span className="font-semibold">Address:</span> 123 Book Lane, Reading City</p>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-theme-bgPrimary/80">
        ...
        <div className="text-center text-sm text-theme-bgPrimary/60">
          <p>© 2026 MarginNotes. All rights reserved.</p>
        </div>
